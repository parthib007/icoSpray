...
const std::size_t Foam::icoSprayParcel<ParcelType>::sizeofFields_
(
    sizeof(icoSprayParcel<ParcelType>) - sizeof(ParcelType)
);
...
template<class ParcelType>
template<class CloudType>
void Foam::icoSprayParcel<ParcelType>::readFields
(
    CloudType& c
)
{
    ...
    label i = 0;
    forAllIter(typename Cloud<icoSprayParcel<ParcelType>>, c, iter)
    {
        icoSprayParcel<ParcelType>& p = iter();
        p.d0_ = d0[i];
...
template<class ParcelType>
template<class CloudType>
void Foam::icoSprayParcel<ParcelType>::writeFields
(
    const CloudType& c
)
{
    ...
    label i = 0;
    forAllConstIter(typename Cloud<icoSprayParcel<ParcelType>>, c, iter)
    {
        const icoSprayParcel<ParcelType>& p = iter();
        d0[i] = p.d0_;
...
)
{
    ...
    else
    {
        ...
        (
            ...
            icoSprayParcel<ParcelType>::sizeofFields_
        );
    }
